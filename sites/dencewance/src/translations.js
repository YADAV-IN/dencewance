...
export const translations = {
  en: {
    ...
    videoUrl: 'Video URL (YouTube / Instagram Reel)',
    source: 'Source',
    summary: 'Summary',
    ...
    newsUpdated: 'Post updated!',
    updateFailed: 'Update failed.',
    newsDeleted: 'Post deleted!',
  ...
  hi: {
    ...
    // Featured Feed
    breakingNews: 'ट्रेंडिंग पोस्ट्स',
    ...
    videoUrl: 'वीडियो URL (YouTube / Instagram Reel)',
    source: 'सोर्स',
    summary: 'सारांश',
    publishTime: 'पब्लिश टाइम (ISO)',
    featured: 'फ़ीचर्ड',
    saveNews: 'पोस्ट सेव करें',
    changePhoto: 'फोटो बदलें',
    
    // Edit Modal
    editNews: 'पोस्ट संपादित करें',
    title: 'शीर्षक',
    required: 'आवश्यक',
    ...
    newsUpdated: 'पोस्ट अपडेट हो गई!',
    updateFailed: 'अपडेट असफल रहा।',
    newsDeleted: 'पोस्ट हटा दी गई!',
